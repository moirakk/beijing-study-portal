...
电阻表示导体对电流**阻碍作用**的大小，用符号 $R$ 表示，单位欧姆（Ω）。在相同电压下，电阻越大，通过导体的电流越小。

**电阻是导体本身的一种性质**，其大小取决于导体的：
- **材料**：不同材料导电性能不同（银、铜导电性最好）；
- **长度**：材料、横截面积相同时，导体越长电阻越大；
- **横截面积**：材料、长度相同时，横截面积越大电阻越小；
- **温度**：一般金属导体温度越高，电阻越大（灯丝电阻随温度升高而增大）。

电阻与电压、电流无关——不能说"电压越大电阻越大"。

**半导体**：导电性能介于导体与绝缘体之间，如硅、锗。半导体的电阻受温度、光照、掺入杂质影响显著，可制成热敏电阻、光敏电阻、二极管等。
...
探究影响电阻大小的因素（**控制变量法**）：
- 比较长度影响：选材料、横截面积相同而长度不同的导线；
- 比较横截面积影响：选材料、长度相同而横截面积不同的导线;
- 比较材料影响：选长度、横截面积相同而材料不同的导线；
...
3. 导体越长电阻越大，越粗电阻越小。
4. 半导体：硅、锗；应用：热敏、光敏电阻，二极管。
5. 超导体电阻为零，可用于输电，但需要极低温。
6. 实验方法：控制变量法 + 转换法。
...
2. 为什么输电线用铜或铝制造而不用铁？
3. 灯泡刚接通瞬间容易烧断灯丝，与电阻随温度的变化有什么关系？
