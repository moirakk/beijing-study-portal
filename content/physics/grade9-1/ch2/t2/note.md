...
热机工作时，燃料释放的能量只有一部分转化为有用的机械功，其余通过废气、散热、摩擦等途径损失。热机效率永远**小于1**。

提高热机效率的途径：使燃料尽可能完全燃烧；减少各种热量损失；保持良好润滑、减小摩擦；利用废气的能量。
...
3. 热机效率 $\eta=W_{\text{有用}}/Q_{\text{放}}$，恒小于1；废气带走的能量最多。
4. 提高效率：完全燃烧、减少热损失、减小摩擦。

## 自测题

1. 完全燃烧 0.5 kg 热值为 $3\times10^{7}$ J/kg 的汽油，放出多少热量？若其中 $6\times10^{6}$ J 用来做有用功，热机效率是多少？
2. 为什么说"提高热机效率对节能减排意义重大"？
