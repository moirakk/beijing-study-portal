...
```mermaid
flowchart TD
    A["不定式 to do"] --> B["主语/表语：It is ... to do"]
    A --> C["宾语：decide / plan / afford / manage + to do"]
    A --> D["宾补：ask / allow / enable / encourage sb to do"]
    A --> E["定语：the ability / chance / way to do"]
    A --> F["状语：目的（in order to / so as to）<br/>结果（only to find）"]
```
