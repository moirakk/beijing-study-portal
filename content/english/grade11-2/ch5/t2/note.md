...
```mermaid
flowchart TD
    A["虚拟条件句：与什么事实相反？"] --> B["与现在相反<br/>if + did / were → would do"]
    A --> C["与过去相反<br/>if + had done → would have done"]
    A --> D["与将来相反<br/>if + did / were to / should → would do"]
    B --> E["混合虚拟：从句与主句时间不同则各按各的"]
    C --> E
```
