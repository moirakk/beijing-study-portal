...
```mermaid
flowchart TD
    A["动名词 doing"] --> B["作主语：Reading widens our horizons."]
    A --> C["作宾语：enjoy / avoid / suggest + doing"]
    A --> D["作介词宾语：be good at doing"]
    A --> E["作表语：My hobby is collecting stamps."]
    A --> F["复合结构：his coming late"]
```
