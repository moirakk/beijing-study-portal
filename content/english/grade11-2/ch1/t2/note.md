...
```mermaid
flowchart TD
    A["不定式 to do"] --> B["作主语：To grow up means to take responsibility."]
    A --> C["作宾语：decide / hope / agree + to do"]
    A --> D["作宾补：ask / allow / encourage sb to do"]
    A --> E["作定语：the ability to make choices"]
    A --> F["作状语：目的 / 结果 / 原因"]
```
