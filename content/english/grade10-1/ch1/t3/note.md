---
title: Unit 1 读写与表达（Developing ideas）
date: 2026-08-07
---
...
```mermaid
flowchart TD
    A["应用文：介绍高中新生活"] --> B["开头段：问候 + 目的（I'm writing to...）"]
    B --> C["主体段1：校园与课程（What impresses me most...）"]
    B --> D["主体段2：社团与朋友（I have signed up for...）"]
    C --> E["结尾段：情感升华 + 期待回信（look forward to）"]
    D --> E
```
...
[[Unit 1 词汇与课文精读（Understanding ideas）]] ｜ [[Unit 4 读写与表达（Developing ideas）]]
