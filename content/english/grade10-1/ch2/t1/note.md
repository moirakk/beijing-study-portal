---
title: Unit 2 词汇与课文精读（Understanding ideas）
date: 2026-08-07
---
...
```mermaid
flowchart TD
    A["Exploring English（语言趣味）"] --> B["“名不副实”现象"]
    A --> C["评价语言的词"]
    A --> D["动作与状态"]
    B --> B1["pineapple, eggplant, hamburger"]
    B --> B2["contradiction, confusing"]
    C --> C1["logical, unique, valuable"]
    C --> C2["make sense, literally"]
    D --> D1["squeeze, vanish"]
```
...
[[Unit 2 语法与语言运用（Using language）]] ｜ [[Unit 2 读写与表达（Developing ideas）]]
