---
title: Unit 3 词汇与课文精读（Understanding ideas）
date: 2026-08-07
---
...
```mermaid
flowchart TD
    A["Family matters（家庭关系）"] --> B["冲突词汇"]
    A --> C["职业词汇"]
    A --> D["和解词汇"]
    B --> B1["generation gap, stubborn, insist"]
    B --> B2["disappointed, argue"]
    C --> C1["lawyer, judge, court, band"]
    D --> D1["communicate, respect, support"]
    D --> D2["compromise, run in the family"]
```
...
[[Unit 3 语法与语言运用（Using language）]] ｜ [[Unit 3 读写与表达（Developing ideas）]]
