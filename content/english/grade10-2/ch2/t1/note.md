...
```mermaid
flowchart TD
    A["主题：Let's celebrate（庆祝节日）"] --> B["仪式活动：ceremony / contest / firework"]
    A --> C["氛围情感：atmosphere / burst into / memorable"]
    A --> D["文化意义：symbol / annual / tradition"]
    B --> E["课文主旨：那达慕 = 文化与精神的庆典"]
    C --> E
    D --> E
```
